...
Here you can see that Appreciate is the SDK where the ad is coming from and the publishing apps (the games monetizing with Appreciate) where the creative for Water Sort was shown.
