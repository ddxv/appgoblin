SELECT domain_name AS company_domain, year, quarter, store, tag_source,
...
UNION ALL
SELECT company_domain, year, quarter, store, tag_source,
    COALESCE(total_apps, 0), COALESCE(total_apps_in_quarter, 0),
    COALESCE(apps_lost, 0), COALESCE(apps_added, 0)
