...
company_totals AS (
    ...
    FROM unioned
    WHERE company_domain IS NOT NULL AND company_domain NOT LIKE 'no-%'
...
GROUP BY
    u.company_domain, u.company_name, u.store, u.tag_source,
