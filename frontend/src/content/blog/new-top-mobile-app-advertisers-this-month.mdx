...
<img src="/blog-images/appgoblin-water_sort_creatives.png" alt="Water Sort Ad Creatives Overview" style="border: 2px solidrgb(117, 126, 143); border-radius: 8px; max-width: 50%; height: auto;" />
...
<img src="/blog-images/appgoblin-water_sort_ad_placements.png" alt="Water Sort Ad Creatives Overview" style="border: 2px solidrgb(129, 139, 157); border-radius: 4px; max-width: 50%; height: auto;" />

Here you can see that [Appreciate.mobi](https://appgoblin.info/companies/appreciate.mobi) is the DSP (owned by [DigitalTurbine](https://appgoblin.info/companies/digitalturbine.com)) where the ad is coming from and the publishing apps (the games monetizing with Appreciate) where the creative for Water Sort was shown.
