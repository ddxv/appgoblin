<script lang="ts">
	...
	const reportUrl = 'https://appgoblin.info/reports/ad-user-acquisition-2026-may';
	const reportPublishedDate = '2026-06-08';
	const reportTemporalCoverage = '2026-05-01/2026-05-31';
		...
		'@graph': [
			{
				...
				about: [
					...
					},
					{
						...
						description: 'Most-distributed video creatives in May 2026'
					}
				],
				mentions: [
					data.apps?.[0]
			...
			},
			{
				'@type': 'Dataset',
				'@id': `${reportUrl}#dataset`,
				name: 'May 2026 Mobile App Advertising Intelligence',
				description:
...
<div class="container mx-auto px-3 md:px-8 xl:px-16 py-6 md:py-8">
	...
	<div class="mb-10 md:mb-12 text-center max-w-4xl mx-auto">
		...
		>
			The ad campaigns behind May's fastest growing mobile apps. AppGoblin breaks the best creatives
	...
	>
		<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-3 mb-5">
			<h2 class="text-2xl md:text-3xl font-bold">App advertising overview - May 2026</h2>
					...
					{#each [data.popularCreatives[2], data.popularCreatives[8], data.popularCreatives[6]] as creative, index}
						<div class="featured-creative-slide">
							<PopularCreativeCard
								{creative}
								{index}
								titlePrefix="May Featured Creative"
	...
	<div class={sectionContainerClass}>
		...
		<div class={sectionDescriptionClass}>
			<p>
				May 2026 shows a mix of SDK inventory and programmatic distribution. In this sample,
	...
	<div class={sectionContainerClass}>
		...
		<div class={sectionBodyClass}>
			...
			<p class={paragraphClass}>
				...
				creative across the widest publisher footprint in May 2026.
			</p>
		</div>
				...
				<div class="flex items-start gap-3 mb-4">
					...
					<div>
						...
						<p class="text-surface-700 dark:text-surface-300">
							Apps that ran May 2026 campaigns averaged {data.summary.avgGrowth}% week-over-week
