...
export const load: PageServerLoad = async ({ fetch }) => {
	...
	const reportPeriod = allData[0]?.trends_latest_period ?? '2026-Q2';
	...
	return {
		...
		description:
			'Quarter-over-quarter mobile ecosystem shifts for SDK and app-ads.txt direct footprints across Google Play and Apple App Store companies in Q2 2026.',
		keywords:
