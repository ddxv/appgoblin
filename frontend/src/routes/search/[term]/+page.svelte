...
<div class="p-4">
	...
	{:then companiesResults}
		{#if typeof companiesResults != 'string'}
			<h2 class="h2 p-4">Companies Matching: '{searchTerm}'</h2>
		...
		{#if typeof results != 'string'}
			{#if results.apps.length > 0}
				...
				<div class="card p-4 mt-4">
					<h3 class="h3">Didn't see the app you're looking for?</h3>
					<p class="p-2">
						This search will check Google Play and App Store and update AppGoblin over the next day.
						Reach out on Discord or GitHub if you have questions or need any support.
					</p>
				</div>
			{:else}
				...
				<h3 class="h3">
					...
					if it exists, should be available in the coming days. Reach out on GitHub or Discord if you
					have any questions.
				</h3>
			{/if}
		{:else}
