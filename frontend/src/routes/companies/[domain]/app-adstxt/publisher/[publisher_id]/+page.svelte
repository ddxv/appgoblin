...
<div class="space-y-4">
		...
		<WhiteCard>
			...
			<div class="p-2">
				<p class="">
					...
					following apps and developers. One or two developers is best with the appropriate number of
					apps from that developer:
				</p>
	...
	<section class="space-y-4">
		...
		{:then publishersApps}
			<h3 class="text-2xl font-bold">Apps DIRECT</h3>
			...
			<h3 class="text-2xl font-bold">Apps RESELLER</h3>
			<div class="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6">
