...
<div class="grid grid-cols-1 gap-4 md:gap-8 px-2 md:px-20 lg:px-48">
	...
	<div class="space-y-0">
		<div class="p-2 md:p-8 space-y-4">
			...
			<p>
				AppGoblin tracks <span class="font-bold text-success-900-100"
					>{formatNumber(data.appsOverview.android_apps)}</span
				>
				Android Apps on Google Play and
				<span class="font-bold text-success-900-100"
					>{formatNumber(data.appsOverview.ios_apps)}</span
				> iOS Apps on the Apple App Store.
			</p>
		</div>

		<div class="card preset-tonal p-2 md:p-8">
			<a href="/ad-creatives">
				<h2 class="h2 p-2 md:p-4">This Month's Top Andoid Advertiser</h2>
			</a>
			<p class="p-2 md:p-4">
