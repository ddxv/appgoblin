...
<div class="p-2 px-2 md:px-16 lg:px-32">
	<section class="space-y-4">
		<div>
			<h2 class="text-3xl font-bold">Ad Placements for {data.myapp.name}</h2>
			<p>
				These are ad spots that were bought by {data.myapp.name}. The publishing apps are the apps
				that where the creatives for {data.myapp.name} were found.
			</p>
		</div>
