...
<div class="p-2 px-2 md:p-8">
	<section class="space-y-4">
		<div>
			<h2 class="text-3xl font-bold">{data.myapp.name}: Ad Creatives</h2>
			<p>
				This is an overview of the creatives that are used to advertise for {data.myapp.name}. Below
				are the thumbnails of the images and videos found.
			</p>
		</div>
