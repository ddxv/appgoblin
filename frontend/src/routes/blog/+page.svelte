...
<div class="container mx-auto px-4 py-8">
	...
	{#if data.posts.length === 0}
		<div class="text-center py-16">
			...
			<h2 class="text-2xl font-semibold text-base-content mb-4">No Posts Yet</h2>
			<p class="text-base-content/70">Check back soon for the latest insights and updates.</p>
		</div>
	{/if}
</div>
