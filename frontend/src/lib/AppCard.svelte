			...
			<div>
				...
				<div class="flex flex-row">
					<div class="flex text-left flex-col">
						...
						{#if app.rating_count && app.rating_count != 0}
							<div class="md:hidden">
								...
								<div class="inline-flex md:hidden gap-2 -200 text-xs">
					...
					<div class="grid grid-cols-1 p-2">
						...
						<!-- Ratings: STARS (123) -->
						{#if app.rating_count && app.rating_count != 0}
							<div class="hidden md:inline-flex gap-2 -200 text-xs md:text-sm">
								<Rating total={5} size={18} rating={app.rating} />
								{formatNumber(app.rating_count)} ratings
							</div>
						{/if}
						<div class="flex flex-row gap-2 text-xs md:text-sm">
						...
						<!-- installs week trend -->
						<div class="flex items-center gap-1 -200 text-xs md:text-sm">
