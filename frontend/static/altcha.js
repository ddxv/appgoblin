...
function Z(e, t = !1, n) {
	W = { p: W, i: !1, c: null, e: null, s: e, x: null, r: jt, l: null };
}
function X(e) {
	var t = W,
		n = t.e;
	if (null !== n) for (var r of ((t.e = null), n)) gn(r);
...
function he(e) {
	...
	return (
		a && r.set('length', St(e.length)),
		new Proxy(e, {
			defineProperty(e, t, n) {
				('value' in n && !1 !== n.configurable && !1 !== n.enumerable && !1 !== n.writable) ||
					(function () {
			...
			has(e, t) {
				...
				if (
					(void 0 !== n || (null !== jt && (!a || l(e, t)?.writable))) &&
					(void 0 === n && ((n = s(() => St(a ? he(e[t]) : Y))), r.set(t, n)), ln(n) === Y)
				)
					return !1;
				return a;
			},
			set(e, t, n, i) {
				...
				void 0 === c
					? (u && !l(e, t)?.writable) || (Et((c = s(() => St(void 0))), he(n)), r.set(t, c))
					: ((u = c.v !== Y),
						Et(
							c,
							s(() => he(n))
...
function xe() {
	if (void 0 === ge) {
		...
		var e = Element.prototype,
			t = Node.prototype,
			n = Text.prototype;
		((ye = l(t, 'firstChild').get),
			(we = l(t, 'nextSibling').get),
			d(e) && ((e[U] = void 0), (e[D] = null), (e[V] = void 0), (e.__e = void 0)),
			d(n) && (n[N] = void 0));
	}
}
function ke(e = '') {
...
function Me(e) {
	if (null !== e) for (const t of e) 2 & t.f && 0 !== (t.f & I) && ((t.f ^= I), Me(t.deps));
}
function De(e, t, n) {
...
function Be(e, t, n) {
	const r = (n[t] ??= { store: null, source: Ct(void 0), unsubscribe: h });
	if (r.store !== e && !(je in n))
		if ((r.unsubscribe(), (r.store = e ?? null), null == e))
			((r.source.v = void 0), (r.unsubscribe = h));
		else {
			var a = !0;
...
class tt {
	...
	skip_effect(e) {
		(this.#h.has(e) || this.#h.set(e, { d: [], m: [] }), this.#p.delete(e));
	}
	...
	#x() {
		for (var e = this.#t; null !== e;) {
			if (!e.is_fork) for (const [t, [, n]] of this.current) if (e.current.has(t) && !n) return e;
			e = e.#t;
		}
		return null;
	}
	#k(e) {
		for (const [t, n] of e.current)
				...
				for (const e of n) {
					...
					if (2 & r) t(e);
						...
						4194320 & r &&
							...
							(this.#d.delete(a), Re(a, x), this.schedule(a));
					}
				}
		};
	...
	capture(e, t, n = !1) {
		(e.v === Y || this.previous.has(e) || this.previous.set(e, e.v),
			0 === (e.f & O) && (this.current.set(e, [t, n]), Ye?.set(e, t)),
			this.is_fork || (e.v = t));
	}
	activate() {
		Ke = this;
			...
			if (c.#e) {
				...
				if (0 === r.length) e && c.discard();
					...
					var l = [...c.current.keys()].filter(
						(e) => !this.current.has(e) || this.current.get(e)[0] !== e.v
					);
					if (l.length > 0)
						for (const e of this.#u)
							155648 & e.f ||
								!it(e, l, o) ||
								(4194320 & e.f ? (Re(e, x), c.schedule(e)) : c.#f.add(e));
					if (c.#c.length > 0) {
...
class ut {
		...
		this.has_pending_snippet()
			? ((this.#M += e),
				0 === this.#M &&
					...
					this.#R && (this.#S.before(this.#R), (this.#R = null))))
			: this.parent && this.parent.#K(e, t);
	}
	...
	error(e) {
		...
		Ke?.is_fork
			? (this.#I && Ke.skip_effect(this.#I),
				this.#P && Ke.skip_effect(this.#P),
				this.#O && Ke.skip_effect(this.#O),
				Ke.on_fork_commit(() => {
					this.#q(e);
				}))
			: this.#q(e);
	...
	#q(e) {
		(this.#I && (Sn(this.#I), (this.#I = null)),
			this.#P && (Sn(this.#P), (this.#P = null)),
			this.#O && (Sn(this.#O), (this.#O = null)),
			oe && (le(this.#C), ue(), le(fe())));
		...
		te(() => {
			...
			null !== t && 'object' == typeof t && 'function' == typeof t.then
				? t.then(i, (e) => Pe(e, this.#A && this.#A.parent))
				: i(t);
		});
	}
}
function ft(e, t, n, r) {
	...
	if (0 !== n.length || 0 !== o.length) {
		var i,
			...
			d =
				1 === o.length ? o[0].promise : o.length > 1 ? Promise.all(o.map((e) => e.promise)) : null,
			h = ht();
		0 !== n.length
			? d
				? d.then(() => {
	...
	return (
		(function (e) {
			...
			if (i) {
				...
				else for (const e of l.values()) e.reject(vt);
			...
			const u = (e, t = void 0) => {
				(c?.(),
					...
					t !== vt &&
						(s.activate(),
						t ? ((o.f |= O), Tt(o, t)) : (0 !== (o.f & O) && (o.f ^= O), Tt(o, e)),
						s.deactivate()));
			};
...
function bt(e) {
	var t,
		n = jt,
		r = e.parent;
	if (!Dt && null !== r && e.v !== Y && 24576 & r.f)
		return (console.warn('https://svelte.dev/e/derived_inert'), e.v);
	Bt(r);
	try {
		((e.f &= -65537),
			(function (e) {
...
function yt(e) {
	...
	e.equals(t) ||
	((e.wv = Xt()),
	(Ke?.is_fork && null !== e.deps) ||
		(null !== Ke ? (Ke.capture(e, t, !0), qe?.capture(e, t, !0)) : (e.v = t), null !== e.deps))
		? Dt || (null !== Ye ? (hn() || Ke?.is_fork) && Ye.set(e, t) : Le(e))
		: Re(e, w);
}
function wt(e) {
	if (null !== e.effects) for (const t of e.effects) t.teardown && null !== t.fn && an(t);
}
let xt = new Set();
const kt = new Map();
let _t = !1;
function $t(e, t) {
	return { f: 0, v: e, reactions: null, equals: F, rv: 0, wv: 0 };
}
function St(e, t) {
	const n = $t(e);
	return (Ht(n), n);
	...
	if (null !== r)
		for (var a = r.length, o = 0; o < a; o++) {
			...
			if ((s && Re(i, t), 0 !== (l & T))) xt.add(i);
				...
				var c = i;
				(Ye?.delete(c),
					0 === (l & I) && (l & y && (null === jt || 0 === (jt.f & P)) && (i.f |= I), It(c, k, n)));
			} else if (s) {
				var u = i;
		...
		document.addEventListener(
			...
			(e) => {
				Promise.resolve().then(() => {
					if (!e.defaultPrevented) for (const t of e.target.elements) t[z]?.();
				});
			},
			{ capture: !0 }
		));
...
function tn(e) {
	...
	try {
		...
		if (null !== Kt) {
			...
			if (hn() && 0 !== (e.f & y)) for (h = qt; h < f.length; h++) (f[h].reactions ??= []).push(e);
		} else !d && null !== f && qt < f.length && (rn(e, qt), (f.length = qt));
		if (!(null === Yt || Nt || null === f || 6146 & e.f))
			for (h = 0; h < Yt.length; h++) en(Yt[h], e);
		if (null !== a && a !== e) {
			if ((Wt++, null !== a.deps)) for (let e = 0; e < n; e += 1) a.deps[e].rv = Wt;
			if (null !== t) for (const e of t) e.rv = Wt;
...
function rn(e, t) {
	var n = e.deps;
	if (null !== n) for (var r = t; r < n.length; r++) nn(e, n[r]);
}
function an(e) {
	var t = e.f;
	if (0 === (t & $)) {
...
function ln(e) {
	...
	if (
		null !== Vt &&
		!Nt &&
		!((null !== jt && 0 !== (jt.f & $)) || (null !== Ft && r.call(Ft, e)))
	) {
		var n = Vt.deps;
		if (0 !== (Vt.f & P))
			e.rv < Wt &&
				((e.rv = Wt),
				null === Kt && null !== n && n[qt] === e ? qt++ : null === Kt ? (Kt = [e]) : Kt.push(e));
		else {
			(Vt.deps ??= []).push(e);
			var a = e.reactions;
...
function sn(e) {
	if (((e.f |= y), null !== e.deps))
		for (const t of e.deps)
			((t.reactions ??= []).push(e), 2 & t.f && 0 === (t.f & y) && (wt(t), sn(t)));
}
function cn(e) {
	if (e.v === Y) return !0;
...
function dn(e, t) {
	...
	if (4 & e) null !== Ze ? Ze.push(r) : tt.ensure().schedule(r);
		...
		null === a.deps &&
			...
			a.first === a.last &&
			0 === (a.f & A) &&
			((a = a.first), 0 !== (e & g) && 0 !== (e & E) && null !== a && (a.f |= E));
	}
	if (
		null !== a &&
		((a.parent = n),
...
function Sn(e, t = !0) {
	...
	((t || 262144 & e.f) &&
		null !== e.nodes &&
		null !== e.nodes.end &&
		(Cn(e.nodes.start, e.nodes.end), (n = !0)),
		Re(e, C),
		$n(e, t && !n),
		rn(e, 0));
...
function An(e, t, n) {
	if (0 === (e.f & _)) {
		...
		for (var a = e.first; null !== a;) {
			var o = a.next;
			if (0 === (a.f & b))
				An(a, t, !!(0 !== (a.f & E) || (0 !== (a.f & m) && 0 !== (e.f & g))) && n);
			a = o;
		}
	}
}
...
function Pn(e, t) {
	if (0 !== (e.f & _)) {
		...
		if (null !== a) for (const e of a) (e.is_global || t) && e.in();
	}
}
function On(e, t) {
	if (e.nodes)
...
function Rn(e) {
	const t = {
		...
		set: (e, n) => {
			('string' == typeof e
				? Object.assign(ze(t.store), { [e]: n })
				: Object.assign(ze(t.store), e),
				t.store.set(ze(t.store)));
		},
		store: Ne(e)
	};
	return t;
...
const Ln = Symbol('events'),
	Mn = new Set(),
	Dn = new Set();
function Un(e, t, n, r = {}) {
	function a(e) {
		if ((r.capture || Bn.call(t, e), !e.cancelBubble)) return Lt(() => n?.call(this, e));
	}
	return (
...
function Bn(e) {
	...
	if (s) {
		var c = a.indexOf(s);
		if (-1 !== c && (t === document || t === window)) return void (e[Ln] = t);
		var u = a.indexOf(t);
		if (-1 === u) return;
		c <= u && (l = c);
	}
	if ((o = a[l] || e.target) !== t) {
		i(e, 'currentTarget', { configurable: !0, get: () => o || n });
		var f = Vt,
			d = jt;
		(zt(null), Bt(null));
		try {
			...
			((e[Ln] = t), delete e.currentTarget, zt(f), Bt(d));
		}
	}
}
const Fn =
...
function Hn(e) {
	...
	return (
		(t.innerHTML = (function (e) {
			return Fn?.createHTML(e) ?? e;
		})(e.replaceAll('<!>', '\x3c!----\x3e'))),
		t.content
	);
}
function Kn(e, t) {
	var n = jt;
	null === n.nodes && (n.nodes = { start: e, end: t, a: null, t: null });
}
function qn(e, t) {
	var n,
		r = !!(1 & t),
	...
	return () => {
		...
		void 0 === n && ((n = Hn(o ? e : '<!>' + e)), r || (n = _e(n)));
		var t = a || be ? document.importNode(n, !0) : n.cloneNode(!0);
		r ? Kn(_e(t), t.lastChild) : Kn(t, t);
		return t;
	};
}
function Yn(e, t, n = 'svg') {
	var r,
		a = `<${n}>${!e.startsWith('<!>') ? e : '<!>' + e}</${n}>`;
	return () => {
		if (oe) return (Kn(ae, null), ae);
		if (!r) {
			var e = Hn(a);
...
function Wn(e = '') {
	...
	var n = ae;
	return (3 !== n.nodeType ? (n.before((n = ke())), le(n)) : Ae(n), Kn(n, n), n);
}
function Jn() {
	if (oe) return (Kn(ae, null), ae);
...
function lr(e, t) {
	...
	try {
		...
		if (
			...
			throw r;
		return (
			r !== q && console.warn('Failed to hydrate: ', r),
			!1 === t.recover &&
				(function () {
...
function cr(
	e,
	{ target: t, anchor: n, props: r = {}, events: o, context: i, intro: l = !0, transformError: s }
) {
	xe();
	var c = void 0,
		u = (function (e) {
			...
			!(function (e, t, n, r) {
				...
				(t) => {
					if (
						...
						oe && Kn(t, null),
						(c = e(t, r) || {}),
						oe && ((jt.nodes.end = ae), null === ae || 8 !== ae.nodeType || ']' !== ae.data))
					)
						throw (re(), q);
					X();
				},
					...
					for (var n = 0; n < e.length; n++) {
						...
						if (!u.has(r)) {
							...
							for (const e of [t, document]) {
								var o = sr.get(e);
								void 0 === o && ((o = new Map()), sr.set(e, o));
								var i = o.get(r);
								void 0 === i
									? (e.addEventListener(r, Bn, { passive: a }), o.set(r, 1))
									: o.set(r, i + 1);
							}
						}
					}
					...
					for (var e of u)
						for (const n of [t, document]) {
							var r = sr.get(n),
								a = r.get(e);
							0 == --a
								? (n.removeEventListener(e, Bn), r.delete(e), 0 === r.size && sr.delete(n))
								: r.set(e, a);
						}
					(Dn.delete(f), l !== n && l.parentNode?.removeChild(l));
				}
			);
		});
	return (ur.set(c, u), c);
			...
			for (const [e, r] of this.#G) {
				...
				const a = () => {
					if (Array.from(this.#Y.values()).includes(e)) {
						...
						(On(r, t), t.append(ke()), this.#W.set(e, { effect: r, fragment: t }));
					} else Sn(r);
...
const pr = Symbol('NaN');
function vr(e, t, n = !1, r = !1, a = !1, o = !1) {
	var i = e,
		l = '';
	if (n) {
		var s = e;
	...
	yn(() => {
		...
		if (l !== (l = t() ?? '')) {
			if (n && !oe)
				return ((e.nodes = null), (s.innerHTML = l), void ('' !== l && Kn(_e(s), s.lastChild)));
			if ((null !== e.nodes && (Cn(e.nodes.start, e.nodes.end), (e.nodes = null)), '' !== l)) {
				if (oe) {
					ae.data;
					for (var o = se(), c = o; null !== o && (8 !== o.nodeType || '' !== o.data);)
						((c = o), (o = $e(o)));
					if (null === o) throw (re(), q);
					return (Kn(ae, c), void (i = le(o)));
				}
				var u = Te(
					r ? 'svg' : a ? 'math' : 'template',
					r ? 'http://www.w3.org/2000/svg' : a ? 'http://www.w3.org/1998/Math/MathML' : void 0
				);
				u.innerHTML = l;
				var f = r || a ? u : u.content;
				if ((Kn(_e(f), f.lastChild), r || a)) for (; _e(f);) i.before(_e(f));
				else i.before(f);
			}
		} else oe && se();
	});
...
function mr(e) {
	...
	if ('string' == typeof e || 'number' == typeof e) r += e;
		...
		if (Array.isArray(e)) {
			var a = e.length;
			for (t = 0; t < a; t++) e[t] && (n = mr(e[t])) && (r && (r += ' '), (r += n));
				...
				for (var a of Object.keys(n))
					if (n[a]) r = r ? r + ' ' + a : a;
						...
						for (var o = a.length, i = 0; (i = r.indexOf(a, i)) >= 0;) {
							var l = i + o;
							(0 !== i && !yr.includes(r[i - 1])) || (l !== r.length && !yr.includes(r[l]))
								? (i = l)
								: (r = (0 === i ? '' : r.substring(0, i)) + r.substring(l + 1));
						}
			return '' === r ? null : r;
		})(n, 0, o);
		((oe && l === e.getAttribute('class')) ||
			(null == l ? e.removeAttribute('class') : t ? (e.className = l) : e.setAttribute('class', l)),
			(e[U] = n));
	} else if (o && a !== o)
		for (var s in o) {
			var c = !!o[s];
			...
			if (t) {
				...
				if ((Array.isArray(t) ? ((n = t[0]), (r = t[1])) : (n = t), e)) {
					...
					var o = !1,
						...
						l = !1,
						s = [];
					(n && s.push(...Object.keys(n).map(xr)), r && s.push(...Object.keys(r).map(xr)));
					var c = 0,
						u = -1;
					const t = e.length;
					for (var f = 0; f < t; f++) {
				...
				return (n && (a += wr(n)), r && (a += wr(r, !0)), '' === (a = a.trim()) ? null : a);
			}
			return null == e ? null : String(e);
		})(t, r);
		((oe && o === e.getAttribute('style')) ||
			(null == o ? e.removeAttribute('style') : (e.style.cssText = o)),
			(e[V] = t));
	} else
		r && (Array.isArray(r) ? (_r(e, n?.[0], r[0]), _r(e, n?.[1], r[1], 'important')) : _r(e, n, r));
	return r;
}
function Sr(e, n, r = !1) {
	if (e.multiple) {
		...
		for (var a of e.options) a.selected = n.includes(Cr(a));
	} else {
		for (a of e.options) {
			if (ve(Cr(a), n)) return void (a.selected = !0);
		}
...
const Er = Symbol('class'),
	Tr = Symbol('style'),
	Ar = Symbol('is custom element'),
	Ir = Symbol('is html'),
	Pr = B ? 'link' : 'LINK',
	Or = B ? 'input' : 'INPUT',
	Rr = B ? 'option' : 'OPTION',
	Lr = B ? 'select' : 'SELECT',
	Mr = B ? 'progress' : 'PROGRESS';
function Dr(e) {
	if (oe) {
		var t = !1,
			n = () => {
...
function Vr(e, t, n, r) {
	...
	(oe &&
		...
		'src' === t || 'srcset' === t || ('href' === t && e.nodeName === Pr))) ||
		(a[t] !== (a[t] = n) &&
			('loading' === t && (e[M] = n),
			null == n
				? e.removeAttribute(t)
				: 'string' != typeof n && Br(e).includes(t)
					? (e[t] = n)
					: e.setAttribute(t, n)));
}
function Nr(e, t, n = [], r = [], a = [], o, i = !1, l = !1) {
	ft(a, n, r, (n) => {
		var r = void 0,
			a = {},
			o = e.nodeName === Lr,
			...
			(xn(() => {
				var c = t(...n.map(ln)),
					u = (function (e, t, n, r, a = !1) {
						if (oe && a && e.nodeName === Or) {
							var o = e;
							('checkbox' === o.type ? 'defaultChecked' : 'defaultValue') in n || Dr(o);
						}
						var i = zr(e),
							l = i[Ar],
							s = !i[Ir];
						...
						(n.class ? (n.class = br(n.class)) : n[Er] && (n.class = null),
							n[Tr] && (n.style ??= null));
						var h = Br(e);
						for (const r in n) {
							let a = n[r];
							if (f && 'value' === r && null == a) ((e.value = e.__value = ''), (u[r] = a));
									...
									if (a !== p || (void 0 === a && e.hasAttribute(r))) {
										...
										if ('$$' !== v)
											if ('on' === v) {
												...
												let o = r.slice(2);
												var g = er(o);
												if ((Xn(o) && ((o = o.slice(0, -7)), (t.capture = !0)), !g && p)) {
													if (null != a) continue;
								...
								} else ($r(e, a, t?.[Tr], n[Tr]), (u[r] = a), (u[Tr] = n[Tr]));
							else
								(kr(e, 'http://www.w3.org/1999/xhtml' === e.namespaceURI, a, 0, t?.[Er], n[Er]),
									(u[r] = a),
									(u[Er] = n[Er]));
						}
						return (c && ie(!0), u);
					})(e, r, c, 0, i, l);
				s && o && 'value' in c && Sr(e, c.value);
				for (let e of Object.getOwnPropertySymbols(a)) c[e] || Sn(a[e]);
				for (let t of Object.getOwnPropertySymbols(c)) {
					var f = c[t];
					('@attach' !== t.description ||
						(r && f === r[t]) ||
						(a[t] && Sn(a[t]), (a[t] = kn(() => gr(e, () => f)))),
						(u[t] = f));
				}
				r = u;
			}),
...
function zr(e) {
	return (e[D] ??= { [Ar]: e.nodeName.includes('-'), [Ir]: e.namespaceURI === G });
}
var jr = new Map();
function Br(e) {
	var t,
		n = e.getAttribute('is') || e.nodeName,
		r = jr.get(n);
	if (r) return r;
	jr.set(n, (r = []));
	for (var a = e, o = Element.prototype; o !== a;) {
		for (var i in (t = s(a)))
			t[i].set && 'innerHTML' !== i && 'textContent' !== i && 'innerText' !== i && r.push(i);
		a = f(a);
	}
	return r;
}
function Fr(e, t, n = t) {
	...
	(!(function (e, t, n, r = n) {
		...
		if (((o = Hr(e) ? Kr(o) : o), n(o), null !== Ke && r.add(Ke), await on(), o !== (o = t()))) {
			...
			if (((e.value = o ?? ''), null !== l)) {
				...
				i === l && l === s && c > s
					...
					: ((e.selectionStart = i), (e.selectionEnd = Math.min(l, c)));
			}
		}
	}),
		((oe && e.defaultValue !== e.value) || (null == un(t) && e.value)) &&
			(n(Hr(e) ? Kr(e.value) : e.value), null !== Ke && r.add(Ke)),
		bn(() => {
			var n = t();
			...
			(Hr(e) && n === Kr(e.value)) ||
				(('date' !== e.type || n || e.value) && n !== e.value && (e.value = n ?? ''));
		}));
}
function Hr(e) {
	var t = e.type;
			...
			return (
				bn(() => {
					((r = i),
						(i = []),
						un(() => {
							qr(n(...i), e) || (t(e, ...i), r && qr(n(...r), e) && t(null, ...r));
						}));
				}),
				() => {
					let r = o;
...
const Gr = {
	...
	getOwnPropertyDescriptor(e, t) {
		if (!e.exclude.includes(t))
			return t in e.props ? { enumerable: !0, configurable: !0, value: e.props[t] } : void 0;
	},
	has: (e, t) => !e.exclude.includes(t) && t in e.props,
	ownKeys: (e) => Reflect.ownKeys(e.props).filter((t) => !e.exclude.includes(t))
};
function Wr(e, t, n) {
	return new Proxy({ props: e, exclude: t }, Gr);
}
function Jr(e, t, n, r) {
	var a,
		o = r,
...
class Zr {
	...
	constructor(e) {
		...
		((this.#ee = (e.hydrate ? lr : ir)(e.component, {
			target: e.target,
			anchor: e.anchor,
			props: r,
			context: e.context,
			...
			(e?.props?.$$host && !1 !== e.sync) || nt(),
			(this.#Q = r.$$events));
		for (const e of Object.keys(this.#ee))
			'$set' !== e &&
				'$destroy' !== e &&
				'$on' !== e &&
				i(this, e, {
		...
		((this.#ee.$set = (e) => {
			...
			(this.#ee.$destroy = () => {
				!(function (e, t) {
					const n = ur.get(e);
					n ? (ur.delete(e), n(t)) : Promise.resolve();
				})(this.#ee);
			}));
	}
	$set(e) {
...
'function' == typeof HTMLElement &&
	(Xr = class extends HTMLElement {
		...
		async connectedCallback() {
			if (((this.$$cn = !0), !this.$$c)) {
				...
				for (const e of this.$$s)
					e in r &&
						('default' !== e || this.$$d.children
							? (n[e] = t(e))
							: ((this.$$d.children = t(e)), (n.default = !0)));
		...
		attributeChangedCallback(e, t, n) {
			this.$$r ||
				((e = this.$$g_p(e)),
				(this.$$d[e] = Qr(e, n, this.$$p_d, 'toProp')),
...
var ta = qn(
	'<div class="altcha-checkbox"><input/> <svg aria-hidden="true" width="12" height="9" viewBox="0 0 12 9"><polyline points="1 5 4 8 11 1"></polyline></svg> <div class="altcha-spinner altcha-checkbox-spinner" aria-hidden="true"></div></div>'
);
function na(e, t) {
	Z(t, !0);
	let n,
		r = Jr(t, 'loading'),
		a = Wr(t, ['$$slots', '$$events', '$$legacy', '$$host', 'loading']);
	var o = {
			get loading() {
				return r();
			},
		...
		i = ta(),
		l = Se(i);
	(Nr(l, () => ({ type: 'checkbox', ...a }), void 0, void 0, void 0, 0, !0),
		Yr(
			l,
			(e) => (n = e),
			() => n
...
(zn(['click']), ea(na, { loading: {} }, [], [], { mode: 'open' }));
var ra = qn(
	'<div class="altcha-checkbox-native"><input/> <div class="altcha-spinner altcha-checkbox-native-spinner"></div></div>'
);
function aa(e, t) {
	Z(t, !0);
	let n = Jr(t, 'loading'),
		r = Wr(t, ['$$slots', '$$events', '$$legacy', '$$host', 'loading']);
	var a = {
			get loading() {
				return n();
			},
		...
		o = ra();
	return (
		Nr(Se(o), () => ({ type: 'checkbox', ...r }), void 0, void 0, void 0, 0, !0),
		ue(2),
		ce(o),
		yn(() => Vr(o, 'data-loading', n())),
		Zn(e, o),
		X(a)
	);
}
ea(aa, { loading: {} }, [], [], { mode: 'open' });
var oa = qn(
...
function ia(e, t) {
	...
	var r = {
		...
		o = Se(a);
	return (
		Vr(o, 'href', 'https://altcha.org'),
		ce(a),
		yn(() => Vr(o, 'aria-label', n().ariaLinkLabel)),
		Zn(e, a),
		X(r)
	);
}
ea(ia, { strings: {} }, [], [], { mode: 'open' });
var la = qn('<div class="altcha-footer"><p></p> <!></div>');
function sa(e, t) {
	Z(t, !0);
	let n = Jr(t, 'logo'),
		r = Jr(t, 'strings');
...
ea(sa, { logo: {}, strings: {} }, [], [], { mode: 'open' });
var ca = qn(
	'<div class="altcha-switch"><input/>  <div class="altcha-switch-toggle"><div class="altcha-spinner altcha-switch-spinner"></div></div></div>'
);
function ua(e, t) {
	Z(t, !0);
	let n,
...
(zn(['click']), ea(ua, { loading: {} }, [], [], { mode: 'open' }));
var fa = ((e) => (
		(e.ERROR = 'error'),
		(e.LOADING = 'loading'),
		(e.PLAYING = 'playing'),
	...
	ha = qn('<div class="altcha-code-challenge-title"> </div>'),
	pa = qn('<div class="altcha-spinner"></div>'),
	va = Gn(
	...
	ba = qn('<button type="button" class="altcha-button altcha-button-secondary"><!></button>'),
	ya = qn('<audio hidden="" autoplay=""></audio>'),
	wa = qn(
...
function xa(e, t) {
	...
	function k() {
		ln(f)
			? ln(u) === fa.LOADING ||
				(ln(f).paused
					? (n() && ln(f).src !== n() && (ln(f).src = n()), (ln(f).currentTime = 0), ln(f).play())
					: ln(f).pause())
			: (Et(v, !0),
	...
	var _ = {
		...
		E = (e) => {
			var t = ha(),
				n = Se(t, !0);
			(ce(t), yn(() => or(n, c().verificationRequired)), Zn(e, t));
		};
	hr(C, (e) => {
	...
	var R = Ee(O, 2),
		L = (e) => {
			...
			(hr(n, (e) => {
				...
				ce(t),
				yn(() => {
					(Vr(t, 'title', c().getAudioChallenge),
						(t.disabled = ln(u) === fa.LOADING || ln(u) === fa.ERROR),
						Vr(t, 'aria-label', ln(u) === fa.LOADING ? c().loading : c().getAudioChallenge));
				}),
				Vn('click', t, () => k(), !0),
				Zn(e, t));
		};
	...
	return (
		...
		ce($),
		yn(() => {
			(or(A, c().enterCodeFromImage),
				Vr(I, 'src', o()),
				Vr(O, 'minlength', r().length || 1),
				Vr(O, 'maxlength', r().length),
				Vr(O, 'placeholder', c().enterCode),
				Vr(
					O,
					'aria-label',
					ln(u) === fa.LOADING ? c().loading : ln(u) === fa.PLAYING ? '' : c().enterCodeAria
				),
				Vr(O, 'aria-live', ln(u) ? 'assertive' : 'polite'),
				Vr(O, 'aria-busy', ln(u) === fa.LOADING),
				Vr(M, 'title', c().reload),
				Vr(M, 'aria-label', c().reload),
				Vr(U, 'aria-label', c().verify),
				or(V, c().verify),
				Vr(N, 'aria-label', c().cancel),
				or(z, c().cancel));
		}),
		Vn(
			'submit',
		...
		Nn('keydown', O, function (e) {
			'Space' === e.code
				? (e.preventDefault(), e.stopPropagation(), k())
				: 'Escape' === e.code && (e.preventDefault(), e.stopPropagation(), i()?.());
		}),
		Fr(
			O,
			() => ln(p),
...
var ka = qn('<div class="altcha-popover-backdrop" data-backdrop=""></div>'),
	_a = qn('<div class="altcha-popover-arrow"></div>'),
	$a = qn('<div role="button" class="altcha-popover-close">&times;</div>'),
	Sa = qn('<!> <div><!> <!> <div class="altcha-popover-content"><!></div></div>', 1);
function Ca(e, t) {
	Z(t, !0);
	let n = Jr(t, 'anchor'),
		r = Jr(t, 'children'),
		a = Jr(t, 'display', 0, 'standard'),
		o = Jr(t, 'backdrop', 0, !1),
		i = Jr(t, 'onClickOutside'),
		l = Jr(t, 'onClickOutsideDelay', 0, 600),
		s = Jr(t, 'onClose'),
		c = Jr(t, 'placement', 0, 'auto'),
		u = Jr(t, 'updateUISignal'),
		f = Jr(t, 'variant', 0, 'neutral'),
		d = Wr(t, [
			'$$slots',
			'$$events',
			'$$legacy',
	...
	(vn(() => {
		...
		dr(() => {
			...
			return (
				e && (ln(v) && document.body.append(ln(v)), ln(p) && document.body.append(ln(p))),
				y(),
				on().then(() => {
					Et(m, Date.now(), !0);
				}),
				() => {
					e &&
						(ln(v) && document.body.removeChild(ln(v)), ln(p) && document.body.removeChild(ln(p)));
				}
			);
		}));
	var w = {
	...
	(Vn(
		...
		Vn('resize', ge, function () {
			y();
		}),
		Vn('scroll', ge, function () {
			y();
		}));
	var k = Ce(x),
		_ = (e) => {
...
async function Ea(e) {
	...
	try {
		...
		if (n instanceof Error && !!n?.message?.includes('Out of memory') && o) {
			u();
			const n = o(s);
			if (n) return Ea({ ...e, challenge: t, controller: r, concurrency: n, createWorker: a });
		}
		throw n;
	} finally {
		u();
...
class Ta {
	...
	touch = [];
	constructor(e = {}) {
		const { maxSamples: t = 60, sampleInterval: n = 50, target: r = window } = e;
		((this.maxSamples = t), (this.sampleInterval = n), (this.target = r), this.attach());
	}
	destroy() {
		const e = { capture: !0 };
		(this.target.removeEventListener('focusin', this.onFocus, e),
			this.target.removeEventListener('keydown', this.onInteraction, e),
			this.target.removeEventListener('pointerdown', this.onInteraction, e),
			this.target.removeEventListener('pointermove', this.onPointer, e),
			this.target.removeEventListener('scroll', this.onScroll, e),
			this.target.removeEventListener('touchmove', this.onTouchMove, e));
	}
	export() {
		return {
			focus: this.focus,
	...
	attach() {
		...
		(this.target.addEventListener('focusin', this.onFocus, e),
			this.target.addEventListener('keydown', this.onInteraction, e),
			this.target.addEventListener('pointerdown', this.onInteraction, e),
			this.target.addEventListener('pointermove', this.onPointer, e),
			this.target.addEventListener('scroll', this.onScroll, e),
			this.target.addEventListener('touchmove', this.onTouchMove, e));
	}
	evict(e) {
	...
	onFocus = (e) => {
		...
		(0 === this.focusStartTime && (this.focusStartTime = n),
			this.focus.push([
				Math.round(n - this.focusStartTime),
				t.tabIndex,
				this.TAG_CODES[t.tagName] ?? 0,
	...
	onInteraction = (e) => {
		((this.focusInteraction = 'keyCode' in e ? 1 : 2),
			this.focusInteractionTimer && clearTimeout(this.focusInteractionTimer),
	...
	onPointer = (e) => {
		...
		((this.pendingPointer = [Math.round(e.clientX), Math.round(e.clientY), Math.round(t)]),
			t - this.lastPointerSample >= this.sampleInterval &&
				(this.pointer.push(this.pendingPointer),
				(this.lastPointerSample = t),
				(this.pendingPointer = null),
				this.evict(this.pointer)));
	};
	onScroll = () => {
		const e = performance.now();
		e - this.lastScrollSample < this.sampleInterval ||
			(this.scroll.push([Math.round(window.scrollY), Math.round(e)]),
			(this.lastScrollSample = e),
	...
	onTouchMove = (e) => {
		...
		n &&
			((this.pendingTouch = [
				...
				Math.round(t),
				Math.round(1e3 * n.force) / 1e3,
				Math.round(n.radiusX || 0),
				Math.round(n.radiusY || 0)
			]),
			t - this.lastTouchSample >= this.sampleInterval &&
				(this.touch.push(this.pendingTouch),
				(this.lastTouchSample = t),
				(this.pendingTouch = null),
				this.evict(this.touch)));
	};
}
var Aa = qn('<div class="altcha-overlay-backdrop" data-backdrop=""></div>'),
	Ia = qn('<div class="altcha-overlay-content"></div>'),
	Pa = qn('<div role="button" class="altcha-overlay-close">&times;</div> <!>', 1),
	Oa = qn('<div class="altcha-floating-arrow"></div>'),
	Ra = qn('<input type="hidden"/>'),
	La = qn('<div class="altcha-error">Secure context (HTTPS) required.</div>'),
	Ma = qn('<div class="altcha-error"> </div>'),
	Da = qn('<div class="altcha-error"> </div>'),
	Ua = qn('<!> <!>', 1),
	Va = qn(
		'<!> <div class="altcha"><!> <div class="altcha-main"><div><div class="altcha-checkbox-wrap"><!> <label><!></label></div> <!></div> <!> <!> <!></div> <!></div>',
		1
	);
'undefined' != typeof window &&
	window.customElements &&
	!customElements.get('altcha-widget') &&
	customElements.define(
		...
		ea(
			function (e, t) {
						...
						return [
							...
							function () {
								pn(() => {
									...
									i(e, je, { enumerable: !1, value: !0 });
								});
							}
						];
					})(),
					a = ['ar', 'fa', 'he', 'ur'],
					{ isSecureContext: o } = globalThis,
					{ store: l } = globalThis.$altcha.defaults,
					s = navigator.hardwareConcurrency || 2,
					c = navigator.deviceMemory || 0,
					u = c && c <= 4 ? Math.min(4, s) : s,
					f = globalThis.$altcha.i18n.store,
					d = t.$$host,
					h = (e, t) => {
						on().then(() => {
							d?.dispatchEvent(new CustomEvent(e, { detail: t }));
						});
					};
				let p = null,
				...
				const L = mt(() => ({
					...
					j = mt(() =>
						(function (e, t) {
							...
							e[r || ''] || (r = 'en');
							return { language: r, strings: e[r] };
						})(Be(f, '$altchaI18nStore', n), [
							ln(L).language,
					...
					K = mt(() =>
						ln(m)?.image?.match(/^(https?:)?\//) ? Q(ln(m).image, ln(v)) : ln(m)?.image
					);
				...
				async function G(e = ln(L).challenge, t) {
					...
					if ('string' == typeof e)
						if (e.startsWith('{')) {
							...
							(_e('fetching challenge from', t?.method || 'GET', e),
								Et(v, new URL(e, location.origin), !0));
							const n = await ln(L).fetch(e, { credentials: ln(L).credentials || void 0, ...t });
							await ye(n);
					...
					if (
							...
							(r = (function (e) {
								...
								const a = {
									...
									parameters: {
										...
										nonce:
											((o = new TextEncoder().encode(e.salt)),
								...
								return (
									Object.defineProperties(a, {
										_originalSalt: { enumerable: !1, value: e.salt, writable: !1 },
						...
						!(function (e) {
							return (
								...
								'algorithm' in e.parameters &&
								'nonce' in e.parameters &&
								'salt' in e.parameters &&
								'keyPrefix' in e.parameters
							);
						})(r))
					)
				...
				function ee(e) {
					!ln(g) && e.currentTarget.checked
						? (e.preventDefault(), (e.currentTarget.checked = !1), ln(w) !== da.VERIFYING && Pe())
						: e.currentTarget.checked || (e.preventDefault(), $e());
				}
				function te(e) {
					ln(w) === da.VERIFYING
						? e.currentTarget.setCustomValidity(ln(F).waitAlert)
						: ln(L).validationMessage && e.currentTarget.setCustomValidity(ln(L).validationMessage);
				}
				function ne() {
					(be(ln(L).display), $e());
				}
				function re(e) {
					'onfocus' === ln(U) && ln(w) === da.UNVERIFIED && Pe();
				}
				function ue() {
					(be(ln(L).display), $e());
				}
				function pe(e) {
					const t = e.target;
					'true' !== t?.getAttribute('data-code-challenge') &&
						'onsubmit' === ln(U) &&
						ln(w) === da.UNVERIFIED &&
						(e.preventDefault(),
						e.stopPropagation(),
				...
				function ve(e) {
					ln(_) && 'requestSubmit' in ln(_)
						? ln(_).requestSubmit(e)
						: ln(_)?.reportValidity() && (e ? e.click() : ln(_).submit());
				}
				function be(e) {
					switch (e) {
						case 'bar':
				...
				async function ye(e) {
					if (e.status >= 400) {
						if (e.headers.get('content-type')?.includes('/json')) {
							...
							if (t && 'error' in t)
								throw new Error(`Server responded with ${e.status} - ${t.error}`);
						}
						throw new Error(`Server responded with ${e.status}.`);
					}
					const t = e.headers.get('content-type');
					if (!t || !t.includes('/json'))
						throw new Error(
							`Server responded with invalid content-type. Expected application/json, received ${t}.`
						);
				}
				async function we(e) {
					if (!ln(A)) return void Te(da.ERROR, 'Cannot verify code challenge without PoW payload.');
					Te(da.VERIFYING);
					let t = null;
					if (ln(L).verifyUrl)
						t = await (async function (e, t) {
							...
							if (void 0 !== n) return n;
							if ((_e('requesting server verification from', ln(L).verifyUrl), !ln(L).verifyUrl))
								throw new Error('Parameter verifyUrl must be set for server verification.');
							const r = await ln(L).fetch(Q(ln(L).verifyUrl, ln(v)), {
								body: JSON.stringify({
									code: t,
									fields: ln(L).serverVerificationFields
										? [
												...(ln(_)?.querySelectorAll(
										...
										: void 0,
									payload: e,
									timeZone: ln(L).serverVerificationTimeZone ? J() : void 0
								}),
							...
							return (
								a &&
									...
									'payload' in a &&
									a.payload &&
									h('serververification', a),
								a
							);
						})(ln(A), e);
					else {
						if (!ln(L).verifyFunction)
							return void Te(
								da.ERROR,
								'Parameter verifyUrl is required for code challenge verification.'
							);
						t = await ln(L).verifyFunction(ln(A), e);
					}
					(t?.payload && (Et(A, t.payload, !0), _e('server payload', ln(A))),
						!0 === t?.verified
							? (_e('verified'),
								Te(da.VERIFIED),
								h('verified', { payload: ln(A) }),
								'onsubmit' === ln(U) &&
									on().then(() => {
										ve(ln(S));
									}))
							: Te(da.ERROR, t?.reason || 'Verification failed.'),
						ln(L).disableAutoFocus || W()?.focus());
				}
				function xe(e) {
					Object.assign(ln(O), {
				...
				function _e(...e) {
					(ln(L).debug || e.some((e) => e instanceof Error)) &&
				...
				function $e(e = da.UNVERIFIED, t = null) {
					(Et(g, !1),
						Et(C, t, !0),
						Et(A, null),
						ln(b) && ln(b).abort(),
						ln(T) && (clearTimeout(ln(T)), Et(T, null)),
						Te(e));
				}
				function Te(e, t = null) {
					(Et(w, e, !0), Et(C, t, !0), h('statechange', { payload: ln(A), state: ln(w) }));
				}
				function Ae() {
					(Et(R, !0),
						on().then(() => {
					...
					if ('floating' === ln(L).display)
						return (function (e = 20) {
							...
							if (
								...
								(Et(
									k,
									(ln(L).floatingAnchor instanceof HTMLElement
										? ln(L).floatingAnchor
										: ln(L).floatingAnchor
											? document.querySelector(ln(L).floatingAnchor)
											: ln(_)?.querySelector(
								...
								return void _e('unable to find floating anchor element');
							...
							if (
								(ln($).style.setProperty('--altcha-floating-left', `${s}px`),
								ln($).style.setProperty(
									'--altcha-floating-top',
									l ? r.top - (a.height + n) + 'px' : `${r.bottom + n}px`
								),
								ln($).setAttribute('data-floating-position', l ? 'top' : 'bottom'),
								ln(x))
							) {
				...
				async function Pe(e = {}) {
					...
					($e(da.VERIFYING), Et(b, n, !0));
					try {
						if (!o) throw new Error('Secure context (HTTPS) required.');
						if (ln(L).mockError) throw new Error('Mock error.');
						if (ln(L).test)
							return (
								_e('running test mode with null challenge'),
								await Y(Math.max(0, r - (performance.now() - a))),
								ln(b)?.signal.aborted
									? ($e(), null)
									: (Et(A, btoa(JSON.stringify({ challenge: null, solution: null, test: !0 })), !0),
										_e('verified'),
										Te(da.VERIFIED),
										h('verified', { payload: ln(A) }),
										{ payload: ln(A) })
						...
						(_e('challenge', i),
							'configuration' in i &&
								(_e('re-configuring from challenge', i.configuration), xe(i.configuration)),
							i.parameters.expiresAt &&
								(function (e) {
									ln(T) && clearTimeout(ln(T));
									const t = () => {
											(ln(w) !== da.UNVERIFIED ? (Et(g, !1), Te(da.EXPIRED)) : $e(), h('expired'));
										},
										n = 1e3 * e - Date.now();
									n >= 1 ? Et(T, setTimeout(t, n), !0) : t();
								})(i.parameters.expiresAt),
							(s = '_version' in i && 1 === i._version));
						...
						if (
							((l = await Ea({
								...
								onOutOfMemory: (e) => {
									if (
										(_e('out of memory error received'),
										h('outofmemory'),
										ln(L).retryOnOutOfMemoryError && e > 1)
									) {
						...
						(_e('solution', l),
							await Y(Math.max(0, r - (performance.now() - a))),
							Et(m, i.codeChallenge || ln(L).codeChallenge || null, !0),
							Et(
								A,
								s
									? btoa(
									...
									: btoa(
											JSON.stringify({
												challenge: { parameters: i.parameters, signature: i.signature },
												solution: l
											})
										),
								!0
							...
							ln(m)
								? (_e('requesting code verification'),
									Te(da.CODE),
									h('codechallenge', { codeChallenge: ln(m) }))
								: ln(L).verifyUrl
									? await we()
									: (_e('verified'), Te(da.VERIFIED), h('verified', { payload: ln(A) })));
					} catch (e) {
						return (_e('verification failed', e), Te(da.ERROR, String(e)), null);
					} finally {
						Et(b, null);
					}
					return { challenge: i, payload: ln(A), solution: l };
				}
				(vn(() => {
					xe({
						auto: t.auto,
					...
					vn(() => {
						ln(g) && ln(w) === da.VERIFYING && Et(g, !1);
					}),
					vn(() => {
						ln(g) || ln(w) !== da.VERIFIED || Et(g, !0);
					}),
					vn(() => {
						if (!ln(g)) {
							const e = W();
					...
					vn(() => {
						ln(w) === da.VERIFIED && W()?.setCustomValidity('');
					}),
					vn(() => {
						if ('onload' === ln(U)) {
							const e = setTimeout(() => {
					...
					dr(
						() => (
							_e('mounted', '3.2.0'),
							d && globalThis.$altcha.instances.add(d),
							Et(_, ln($)?.closest('form'), !0),
							ln(_)?.addEventListener('reset', ue),
							ln(_)?.addEventListener('submit', pe, { capture: !0 }),
							ln(_)?.addEventListener('focusin', re),
							(function () {
								(Et(
									I,
									[...globalThis.$altcha.plugins].map((e) => new e(d)),
									!0
								),
									_e(
										'activating plugins',
										ln(I).map((e) => e.constructor.name)
									));
								for (const e of ln(I)) e.activate();
							})(),
							ln(L).humanInteractionSignature &&
								(_e('human interaction signature enabled'), (p = new Ta())),
							h('load'),
							o || _e('secure context (HTTPS) required'),
							() => {
								(!(function () {
									for (const e of ln(I)) e.destroy();
								})(),
									d && globalThis.$altcha.instances.delete(d),
									ln(T) && clearTimeout(ln(T)),
									ln(_)?.removeEventListener('reset', ue),
									ln(_)?.removeEventListener('submit', pe, { capture: !0 }),
									ln(_)?.removeEventListener('focusin', re),
									p?.destroy());
							}
						)
					));
				var Oe = {
					...
					Re = Va();
				(Vn('scroll', me, function () {
					Ie();
				}),
					Vn('click', me, function (e) {
						const t = e.target;
						'floating' !== ln(L).display ||
							!t ||
							d?.contains(t) ||
							t.hasAttribute('data-backdrop') ||
							t.closest('[data-popover]') ||
							ln(w) === da.VERIFIED ||
							ln(L).floatingPersist ||
							ke();
					}),
					Vn('pageshow', ge, function (e) {
				...
				var De = Ee(Le, 2),
					...
					Ve = (e) => {
						var t = Pa(),
							...
							a = (e) => {
								var t = Ia();
								(vr(t, () => document.querySelector(ln(L).overlayContent)?.innerHTML, !0),
									ce(t),
									Zn(e, t));
							};
						(hr(r, (e) => {
				...
				{
					let e = mt(
						() => ('standard' === ln(L).display && 'onsubmit' !== ln(U)) || ln(w) === da.VERIFYING
					);
					!(function (e, t, n) {
						var r;
						oe && ((r = ae), se());
				...
				var Ke = Ee(He, 2),
					...
					Ye = (e) => {
						var t = Wn();
						(yn(() => or(t, ln(F).verificationRequired)), Zn(e, t));
					},
					Ge = (e) => {
						var t = Wn();
						(yn(() => or(t, ln(F).verifying)), Zn(e, t));
					},
					We = (e) => {
						var t = Wn();
						(yn(() => or(t, ln(F).verified)), Zn(e, t));
					},
					Je = (e) => {
						var t = Wn();
						(yn(() => or(t, ln(F).label)), Zn(e, t));
					};
				(hr(qe, (e) => {
					ln(w) === da.CODE && ln(m)
						? e(Ye)
						...
						(Dr(t),
							yn(() => {
								...
								(Vr(t, 'name', ln(L).name),
									(e = t),
									(n = ln(A)),
									(r = zr(e)).value !== (r.value = n ?? void 0) &&
										(e.value !== n || (0 === n && e.nodeName === Mr)) &&
										(e.value = n ?? ''));
							}),
							Zn(e, t));
					};
							...
							children: (e, t) => {
								var n = Jn(),
									...
									i = (e) => {
										var t = Ma(),
											n = Se(t, !0);
										(ce(t), yn(() => or(n, ln(F).expired)), Zn(e, t));
									},
									l = (e) => {
										var t = Da(),
											n = Se(t, !0);
										(ce(t),
											yn(() => {
												(Vr(t, 'title', ln(C)), or(n, ln(F).error));
											}),
											Zn(e, t));
									};
								(hr(r, (e) => {
									ln(C) || o ? (ln(C) || ln(w) !== da.EXPIRED ? e(l, -1) : e(i, 1)) : e(a);
								}),
									Zn(e, n));
							},
							$$slots: { default: !0 }
				...
				(hr(ot, (e) => {
					ln(C) || ln(w) === da.EXPIRED || !o ? e(it) : ln(m) && ln(w) === da.CODE && e(lt, 1);
				}),
					ce(De),
					Yr(
						De,
					...
					yn(
						(e) => {
							(Vr(De, 'data-state', ln(w)),
								Vr(De, 'data-display', ln(L).display || void 0),
								Vr(De, 'data-placement', e),
								Vr(De, 'data-visible', ln(R) || void 0),
								Vr(De, 'dir', ln(B)),
								Vr(Ke, 'for', ln(M)),
								(De.dir = De.dir));
						},
...
const Na =
	...
	za =
		...
		self.Blob &&
		new Blob(['(self.URL || self.webkitURL).revokeObjectURL(self.location.href);', Na], {
...
function ja(e) {
	...
	try {
		...
		return new Worker('data:text/javascript;charset=utf-8,' + encodeURIComponent(Na), {
			name: e?.name
		});
	}
}
const Ba =
	...
	Fa =
		'undefined' != typeof self &&
		self.Blob &&
		new Blob(['(self.URL || self.webkitURL).revokeObjectURL(self.location.href);', Ba], {
			type: 'text/javascript;charset=utf-8'
		});
function Ha(e) {
	let t;
	try {
		if (((t = Fa && (self.URL || self.webkitURL).createObjectURL(Fa)), !t)) throw '';
		const n = new Worker(t, { name: e?.name });
		return (
			n.addEventListener('error', () => {
				(self.URL || self.webkitURL).revokeObjectURL(t);
		...
		return new Worker('data:text/javascript;charset=utf-8,' + encodeURIComponent(Ba), {
			name: e?.name
		});
	}
}
(!(function (e, t = 'altcha-css') {
	if ('undefined' != typeof document && document && !document.getElementById(t)) {
		...
		const r =
			document.currentScript?.nonce ?? document.querySelector('meta[name="csp-nonce"]')?.content;
	...
	$altcha.algorithms.set('SHA-256', () => new Ha()),
	$altcha.algorithms.set('SHA-384', () => new Ha()),
	$altcha.algorithms.set('SHA-512', () => new Ha()),
	$altcha.algorithms.set('PBKDF2/SHA-256', () => new ja()),
	$altcha.algorithms.set('PBKDF2/SHA-384', () => new ja()),
	$altcha.algorithms.set('PBKDF2/SHA-512', () => new ja()));
